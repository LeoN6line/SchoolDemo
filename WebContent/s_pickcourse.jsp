<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import = "java.util.ArrayList,com.Leon.entity.Course,com.Leon.dao.courseDao" %>
...
<td width = 100dp><a href = "s_PickCourseServlet?id=<%=course.getCid()%>">选课</a></td>
</tr>
<% }%>
</table>
<a href = "s_course.jsp">查看已选课程</a>
</center>
